...
INSERT INTO pessoa VALUES ('102.312.573-45', 'Rodrigo Martins Morais','14-OCT-1986', 'Rua Getulio Vargas', '221', 'Recife');
INSERT INTO pessoa VALUES ('564.328.478-98', 'Mario damorin ', '18-JUL-1968', '7 rua de baixo', '598', 'Caruaru');
INSERT INTO pessoa VALUES ('689.207.420-42', 'Debora Paula dos Santos','14-OCT-1991', 'Rua Brigadeiro', '31', 'São Paulo');
INSERT INTO pessoa VALUES ('986.124.785-45', 'João Gonçalves Almeida', '15-MAR-1998', 'Avenida Recife', '128', 'Recife');
INSERT INTO pessoa VALUES ('198.228.735-87', 'Clara Maria Cornelho', '10-DEC-2006', 'Avenida 50', '15', 'Pedras de Fogo');
INSERT INTO pessoa VALUES ('078.845.996-12', 'Maria josé Santiago', '09-JUL-2003', 'Travessa Arco-íris', '42', 'Recife');
INSERT INTO pessoa VALUES ('678.191.458-44', 'Joana Maria ', '20-AUG-1999', 'Rua Laranjeira', '59', 'Carrapicho');
INSERT INTO pessoa VALUES ('635.152.669-17', 'Camila de Azevedo', '23-FEB-1985', 'Rua caminhão derrapado', '1245', 'Petrolina');
INSERT INTO pessoa VALUES ('456.712.223-00', 'Matheus Alves', '13-MAY-1980', '5° travessa do meio', '18', 'Recife');
INSERT INTO pessoa VALUES ('514.378.321-98', 'Lara Alexandra Silva ', '19-APR-1978', 'Travessa do Milho', '72', 'Carne de Vaca');
INSERT INTO pessoa VALUES ('123.684.742-66', 'Pamella ','15-JAN-2000', 'Avenida Pinheiros','255','Recife');
INSERT INTO pessoa VALUES ('275.789.321-80', 'Marcos da Silva', '01-MAR-2005', 'Cruzada do Cruzeiro', '09', 'Ponta de Pedra');
INSERT INTO pessoa VALUES ('033.858.634-99','Kauã Frederico','16-JUN-1999','Condomínio AlphaVille Premium Master','03','Recife');
INSERT INTO pessoa VALUES ('923.084.271-60', 'Junior Souza', '29-DEC-1945', 'Primeira rua de Caminho', '78', 'Diamantina');
INSERT INTO pessoa VALUES ('444.608.646-49', 'Brenda C Rocha','13-MAY-1958', 'Rua João Pessoa', '766', 'Jundiai');
INSERT INTO pessoa VALUES ('116.758.622-06','Marina C Dias', '05-AUG-1965','Rua Petronília Dersia', '1356','Salvador');
INSERT INTO pessoa VALUES ('987.925.913-02', 'Tiago M Alves','11-APR-1985', 'Rua Telemaco Borba', '643', 'Camaragibe');
INSERT INTO pessoa VALUES ('371.866.227-20', 'Leonor Azevedo', '10-MAY-1975','Rua Quatro', '541', 'Divinópolis');
INSERT INTO pessoa VALUES('892.549.556-20', 'Vinicius C Dias', '16-NOV-1966', 'Rua Armando Colo', '823', 'Carne de Vaca');
INSERT INTO pessoa VALUES ('276.787.174-15', 'Mauro Sérgio', '05-MAY-1962', 'Time Square','324','New York');
INSERT INTO pessoa VALUES ('573.972.289-18', 'Clarissa B. Ribeiro', '15-JUN-1986', 'Terceira rua do Limão', '450', 'João Pessoa');
INSERT INTO pessoa VALUES ('181.250.432-25', 'Vitor G Ribeiro', '5-DEC-1970', 'Rua João Florêncio Fontes', '1091', 'Osasco');
INSERT INTO pessoa VALUES ('903.695.561-00', 'Júlia O Fernandes', '21-APR-1990', 'Avenida Marginal', '1857', 'Jundiai');
INSERT INTO pessoa VALUES ('673.629.234-98', 'Luana Santana de Moureira', '01-AUG-1982', 'Rua de cima', '04', 'Carne de Vaca');
INSERT INTO pessoa VALUES ('727.729.412-21', 'Clara A Silva', '08-AUG-1967', 'Rua Servidão Vieira da Silva ', '1370', 'Manaus');
INSERT INTO pessoa VALUES('112.352.284-68', 'Márcia Araújo', '09-MAR-1984', 'Fazenda Campo Alegre', '188', 'Manaus');
INSERT INTO pessoa VALUES ('612.547.610-39', 'Sofia C Fernandes', '12-JAN-1981', 'Rua Lima', '797', 'Ribeirão das Neves');
INSERT INTO pessoa VALUES ('177.235.819-39', 'Rafaela P Gomes', '8-MAR-1961', 'Rua Wlademira do Amaral', '293', 'Manaus');
INSERT INTO pessoa VALUES ('602.897.321-75', 'João Maria', '20-NOV-1974', 'Escada de Cima', '08', 'Garanhuns');
INSERT INTO pessoa VALUES ('326.182.003-00','Manoel Freitas','31-AUG-2001', 'Aeroporto São Domingos','75','Garanhuns');
INSERT INTO pessoa VALUES ('321.565.194-71', 'Tomás C Correia', '31-MAR-1973', 'Avenida Cuiabá', '17', 'Garanhuns');
INSERT INTO pessoa VALUES ('785.214.448-76','Carlito Teves','04-SEP-1981','Avenida José Castro','44','Caruaru');
INSERT INTO pessoa VALUES ('902.345.278-38', 'Susana de Cássia','06-MAR-1972', 'Rua das Laranjeiras', '91', 'Palmares');
INSERT INTO pessoa VALUES ('183.989.570-50', 'Ágatha F Azevedo','03-OCT-1970', 'Rua Acapulco ', '1971', 'Palmares');
INSERT INTO pessoa VALUES ('201.811.925-78', 'Marina A Gomes','09-APR-1969', 'Rua Dom Severino Vieira de Melo', '1234', 'Caruaru');
INSERT INTO pessoa VALUES ('454.187.783-92', ' Marcos Júnior Silva','05-SEP-1975', 'Rua do Centro', '87', 'Recife');
INSERT INTO pessoa VALUES ('201.111.904-67', 'Carlos Justos','07-DEC-2002', 'Travessa da Quinta Avenida', '01', 'Carne de Vaca');
INSERT INTO pessoa VALUES ('292.957.379-11', 'Manuela P Lima','05-DEC-1957', 'Rua Ibicuí', '558', 'Caruaru');
INSERT INTO pessoa VALUES ('277.543.780-89', 'Ruana Martins','09-NOV-1977', 'Rua do Limoeiro', '23', 'João Pessoa');
INSERT INTO pessoa VALUES ('551.999.793-45', 'Otávio C Pinto','03-FEB-1957', 'Rua Jornalista Nelson Pereira de Lima', '1411', 'Recife');
INSERT INTO pessoa VALUES('989.445.235-96','Marco Polo','31-MAY-2006','Fazenda Haroldo Feitosa','112','Petrolina');
INSERT INTO pessoa VALUES ('102.300.573-45', 'Cássio Monteiro','29-JUN-1997', 'Rua João Pessoa', '83', 'Caruaru');
INSERT INTO pessoa VALUES ('102.312.573-00', 'Luiza Castro','02-AUG-2000', 'Rua Principal 1', '789', 'Caruaru');
INSERT INTO pessoa VALUES ('211.624.902-33', 'Enzo C Almeida','10-MAR-1976', 'Rua das Flores', '163', 'Petrolina');
INSERT INTO pessoa VALUES('305.178.336-88','Napo Litano Bona Arte','01-DEC-1977','Rua Paris','1770','São Paulo');
INSERT INTO pessoa VALUES('801.283.373-54','Erick C Sousa','08-JAN-1972','Avenida São João', '1813','São Paulo');
INSERT INTO pessoa VALUES ('789.543.725-98', 'João M. Freitas','17-NOV-1991', 'Avenida da luz', '82', 'São Paulo');
INSERT INTO pessoa VALUES ('603.856.173-05', 'Davi R Correia','09-AUG-1962', 'Rua José Vicente Lacerda', '1961', 'São Paulo');
INSERT INTO pessoa VALUES ('012.325.641-22' , 'Matheus Correia','30-AUG-2001','Avenida Beltrão','35','Recife');
INSERT INTO pessoa VALUES ('395.888.475-08', 'Caio D Alves','06-APR-1962', 'Rua Tupy-A', '1153', 'Garanhuns');
INSERT INTO pessoa VALUES ('872.341.092-09', 'Felipe de Souza','28-FEB-1982', 'Rua do Cajueiro', '37', 'Garanhuns');
INSERT INTO pessoa VALUES ('931.071.938-95', 'Vitoria F Cavalcanti','6-JUN-1975', 'Rua Marechal Cândido Rondon', '443', 'Caruaru');
INSERT INTO pessoa VALUES ('453.197.932-41','Sálvio Moura','12-MAR-1960','Quadra 4','25','Vitória de Santo Antão');
INSERT INTO pessoa VALUES ('187.217.142-74', 'Felipe S Correia','24-SEP-1960', 'Avenida Líndice', '1166', 'Vitória de Santo Antão');
INSERT INTO pessoa VALUES ('678.094.174-44', 'Caio Juarez','16-JUL-1999', 'Rua Vitoriosa', '89', 'Vitória de Santo Antão');
...
INSERT INTO obra_de_arte VALUES (identificadorr_obra_de_arte_cq.nextval,'602.897.321-75','Labirinto dos Céus','Pintura', 12000.00, '25-JAN-2013');
INSERT INTO obra_de_arte VALUES (identificadorr_obra_de_arte_cq.nextval,'602.897.321-75','Pensamento de Cézar','Escultura', 30000.00, '13-JAN-1989');
INSERT INTO obra_de_arte VALUES (identificadorr_obra_de_arte_cq.nextval,'602.897.321-75','O Pé Grande','Pintura', 4500.00, '11-MAY-2002');
INSERT INTO obra_de_arte VALUES (identificadorr_obra_de_arte_cq.nextval,'602.897.321-75','Escuridão','Pintura', 5600.00, '15-APR-2021');
INSERT INTO obra_de_arte VALUES (identificadorr_obra_de_arte_cq.nextval,'602.897.321-75','O choro','Escultura', 80000.00, '19-MAY-2000');
INSERT INTO obra_de_arte VALUES (identificadorr_obra_de_arte_cq.nextval,'602.897.321-75','A torre de ossos','Escultura', 5300.0, '08-APR-1940');
INSERT INTO obra_de_arte VALUES (identificadorr_obra_de_arte_cq.nextval,'602.897.321-75','Coraline','Pintura', 200000.0, '20-FEB-2002');
INSERT INTO obra_de_arte VALUES (identificadorr_obra_de_arte_cq.nextval,'602.897.321-75','Morte','Pintura', 20500.0,'29-JAN-1954');
INSERT INTO obra_de_arte VALUES (identificadorr_obra_de_arte_cq.nextval,'602.897.321-75','Caminho para o céu','Pintura', 86710.0, '08-APR-1996');
INSERT INTO obra_de_arte VALUES (identificadorr_obra_de_arte_cq.nextval,'602.897.321-75','Chápeu Amarelo','Escultura', 5000.0, '13-JUL-1994');
INSERT INTO obra_de_arte VALUES (identificadorr_obra_de_arte_cq.nextval,'573.972.289-18','Torre de babel','Escultura', 18000.00, '05-NOV-1966');
INSERT INTO obra_de_arte VALUES (identificadorr_obra_de_arte_cq.nextval,'573.972.289-18','Estrada de espinhos','Escultura', 126000.00, '02-NOV-2001');
INSERT INTO obra_de_arte VALUES (identificadorr_obra_de_arte_cq.nextval,'573.972.289-18','Amazônia Azul','Pintura', 56000.00, '07-APR-2010');
INSERT INTO obra_de_arte VALUES (identificadorr_obra_de_arte_cq.nextval,'573.972.289-18','Lonamisa','Pintura', 7420.00, '04-JUL-2021');
INSERT INTO obra_de_arte VALUES (identificadorr_obra_de_arte_cq.nextval,'573.972.289-18','Rosto sem cores','Pintura', 89000.00, '09-DEC-1983');
INSERT INTO obra_de_arte VALUES (identificadorr_obra_de_arte_cq.nextval,'276.787.174-15','O Banco de Dados','Escultura', 18500.00, '26-JAN-2014');
INSERT INTO obra_de_arte VALUES (identificadorr_obra_de_arte_cq.nextval,'276.787.174-15','Sonalima','Pintura', 32000.00, '09-APR-2015');
INSERT INTO obra_de_arte VALUES (identificadorr_obra_de_arte_cq.nextval,'276.787.174-15','Pintura Lendária','Escultura', 100000.00, '21-JUL-1975');
INSERT INTO obra_de_arte VALUES (identificadorr_obra_de_arte_cq.nextval,'177.235.819-39','Século Novo','Pintura', 89005.00, '31-DEC-1999');
INSERT INTO obra_de_arte VALUES (identificadorr_obra_de_arte_cq.nextval,'177.235.819-39','O limão','Escultura', 90005.00, '09-FEB-1982');
...
INSERT INTO seguro VALUES (seguro1_cq.nextval, 2, '785.214.448-76', 600.00);
INSERT INTO seguro VALUES (seguro1_cq.nextval, 5, '902.345.278-38', 1600.00);
INSERT INTO seguro VALUES (seguro1_cq.nextval, 7, '785.214.448-76', 4000.00);
INSERT INTO seguro VALUES (seguro1_cq.nextval, 12, '183.989.570-50', 2520.00);
INSERT INTO seguro VALUES (seguro1_cq.nextval, 15, '785.214.448-76', 1780.00);
INSERT INTO seguro VALUES (seguro1_cq.nextval, 18, '902.345.278-38', 2000.00);
...
--POVOAMENTO DA TABELA COMUNICAO PESSOA
