...
CREATE TABLE funcionario(
    ...
    supervisor_cpf VARCHAR(15) NOT NULL,
...
INSERT INTO pessoa VALUES (124, 'pedro','1001/03/12', '6 travessa do meio', '18', 'vitoria');

INSERT INTO funcionario VALUES ('124', '123','supervisionado');

CREATE SEQUENCE identificador_obra_de_arte_cq INCREMENT BY 1 START WITH 1;

INSERT INTO obra_de_arte VALUES (1,'123','monalisa','pintura', 200000.0, '1009/03/06');

CREATE TABLE reliquia(
    identificador_reliquia INTEGER,
    cpf_funcionario VARCHAR(15) NOT NULL,
    nome_reliquia VARCHAR(50) NOT NULL,
    categoria_reliquia VARCHAR(15) NOT NULL,
